...
<?php
$pdo = connect();
  $results = $pdo->query("SELECT course.course_id,course.course_name,course.course_day,course.course_time,course.knowledge,course.price,tutor.tut_first,course.image FROM course INNER JOIN tutor on tutor.tut_id=course.tut_id", PDO::FETCH_ASSOC);
...
<div class="box_2">
<label id="place_2">Course:<?php".$_POST['']." ?></label>
<label id="place_2">Tutor: <?php".$_POST['']." ?></label>
<label id="place_2">Time: <?php".$_POST['']." ?></label>
<label id="place">Price: <?php".$_POST['']." ?></label>
<button id="btn_edit_2">Book <?php".$_POST['']." ?></button>
</div>
