...
<body>
<h2 class="title">MasterClasses Employee</h2>
...
<button id="btn"><a class="edit_link" href="signupindex.php">Sign up</a></button><br>
<button id="btn" type="submit">Login</button>
<button id="btn" ><a class="edit_link"href="loginindex.php">User Login</button></a>
</div></form>
